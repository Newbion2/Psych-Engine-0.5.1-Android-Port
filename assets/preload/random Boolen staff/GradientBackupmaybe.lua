...
function onEvent(name, value1, value2)
	if name == 'Gradient' then
		...
		if Gradient == 1 then
			doTweenAlpha('dient1', 'gradient1', 0.3, 0.8, 'linear')
            --setProperty('gradient1.alpha', 0.8)
		elseif Gradient == 2 then
			doTweenAlpha('dient2', 'gradient2', 0.3, 0.8, 'linear')
            --setProperty('gradient2.alpha', 0.8)
		elseif Gradient == 3 then
			doTweenAlpha('dient3', 'gradient3', 0.3, 0.8, 'linear')
            --setProperty('gradient3.alpha', 0.8) --gragragradientdiendientdientdientsient
                    end
                end
            end
        end
  ...
  elseif value1 == '2' then
     ...
     function onBeatHit()
		...
		elseif Gradient == 2 then
			...
			setProperty('gradient2.alpha', 0.8)
		elseif Gradient == 3 then
			doTweenAlpha('dient6', 'gradient3', 0, 0.4, 'linear')
			setProperty('gradient3.alpha', 0.8)
                                end                  
                            end
                        end
                    end
                end --end is the worst fc
            end
        end --i want hscript now i fresk hate end